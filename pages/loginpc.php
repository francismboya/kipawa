...
<div id='ajaxorg'>
    ...
    <!--yang-->
    <div id="jk" style="visibility:hidden">
        <html>
                ...
                <div style="width: 1000px; border: 0px solid red; margin: auto;padding-bottom: 50px;overflow: auto; ">
                    <div style="float: left; width: 400px; border: 0px; margin: 0px 0px 0px 10px; font-size: 12px;">
                        ...
                        <p><b style="font-size:15px; color:black"> Welcome to SRMS</b><br />
                            <span style="margin-left: 15px; display: block; font-size:15px; color:black">The Student
                                Record
                                Management
                                System (SRMS)
                            ...
                            <div class="login-clean">
                                ...
                                <form method="post" action="processlogin.php" style="padding:3px" id="lgforms">
                                    ...
                                    <input class="form-control input-pass" type="password" name="password"
                                        id="passwords" placeholder="Password" style="width:300px; margin-left:40px">

                                    <button class=" btn btn-primary btn-block" name="btnlogin" type="submit"
                                        id='btnlogins' style="width:300px; margin-left:40px">Log In</button><a
                                        class=" forgot" id="forgot" href="#">Forgot
                                        your email or
                                        password?</a>
                                </form>
                            </div>
    ...
    jcb = document.getElementById("jk");
    jcb.style.visibility = "visible";
    </script>
