...
<body>
    <div id="home">
        <div id="head">
            <div style="float: left; width: 160px; height: 90px; margin: 0px 0px 0px 100px;  border: 0px solid red;">
        ...
        <div style="width: 1000px; border: 0px solid red; margin: auto;padding-bottom: 50px;overflow: auto; ">
            <div style="float: left; width: 400px; border: 0px; margin: 0px 0px 0px 10px; font-size: 12px;">
                ...
                <p><b style="display: block; font-size:15px; color:black">Students</b></label>
                    <span style="display: block; text-indent: 15px; font-size:15px; color:black"><b>*</b> Register for
                        Courses online</span>
                    <span style="display: block; text-indent: 15px; font-size:15px; color:black"><b>*</b> View Course
                        Progress and Results</span>
                    <span style="display: block; text-indent: 15px; font-size:15px; color:black"><b>*</b> Forums</span>
                ...
                <p>
                    ...
                    <span style="display: block; text-indent: 15px; font-size:15px; color:black"><b>*</b> View list of
                        Students per Course</span>
                    <span style="display: block; text-indent: 15px; font-size:15px; color:black"><b>*</b> Publish Course
                        Results</span>
                    <span style="display: block; text-indent: 15px; font-size:15px; color:black"><b>*</b> Track Students
            ...
            <div style="float: left; height: 350px; border: 1px solid #494949; width: 0px; margin: 12px 0px 0px 0px;">
            </div>
            <div style="float: left; width: 500px; border: 0px; margin: 20px 0px 0px 20px;">
                ...
                <div class="div1">
                    <div class="login-clean">
                        <h1>Login</h1>
                        <form method="post" action="processlogin.php" style="padding:3px">
                            <input class="form-control input-user" type="email" name="user" placeholder="Email"
                                style="width:300px; margin-left:40px">

                            <input class="form-control input-pass" type="password" name="password"
                                placeholder="Password" style="width:300px; margin-left:40px">

                            <button class=" btn btn-primary btn-block" name="btnlogin" type="submit"
                                style="width:300px; margin-left:40px">Log In</button><a class=" forgot" href="#">Forgot
                                your email or
                                password?</a>
                        </form>
                    </div>
    ...
    <div id="footer">
        ...
        <p id="developers"><span> Designed and Developed by :</span> <a href="#" target="_blank"> KIPAWA ICT CENTRE</a>
