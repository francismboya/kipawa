...
$query = "SELECT * FROM employee join status on status.email=employee.email WHERE status.statusName='teacher' OR status.statusName='hod' or status.statusName='registrar' or status.statusName='principal' or status.statusName='admin'";
