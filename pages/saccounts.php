            ...
            <form action='' method='post'>
                <div class='row'>
                    <div class="form-group col-sm-3">
                        <h4 class="m-2 font-weight-bold text-primary"> Student Account
                        </h4>
                    </div>
                    <div class="form-group col-sm-3">
                        <div class='animate'>
                    ...
                    <div class="form-group col-sm-5">
                        ...
                        <input type='button' id='std1' class="btn btn-primary bg-gradient-primary"
                            value='view employee Account'>
                    </div>
        ...
        <div class="card-body">
            <div class="table-responsive" style="font-size:14px">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
$query = 'SELECT regno, e.email, fname, lname, s.statusName, s.lstate FROM student e join status s on s.email=e.email';
$result = mysqli_query($db, $query) or die(mysqli_error($db));
