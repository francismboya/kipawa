                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <h6 class="card-title font-italic font-weight-bold">This
                                                                section lets you
                                                                view your
                                                                results for particular year of study, Please select a
                                                                year of study to view your results:</h6>
                                                            <?php $a++;}?>
                                                            <li><a
                                                                    href="hresult1.php?year=<?php echo substr($oursem['seID'], 5) ?>">
                                                                    Course Results - <?php echo $oursem['seID'] ?>
                                                                </a></li>
                                                            <?php
$a++;
    }
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text text-light bg-info"
                                                                style="font-size:30px">No academic
                                                                session started
                                                                yet
                                                            </p>
