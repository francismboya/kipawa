...
$sqln = "select * from(SELECT count(*)pass FROM `coursework` WHERE (remarks='pass') and courseID='" . $decryption1 . "' and coID='" . $cid . "')a
join
(SELECT count(*)fail FROM `coursework` WHERE (remarks='fail') and courseID='" . $decryption1 . "' and coID='" . $cid . "') b";
...
//A B C D
$sqlng = "select * from(SELECT count(*)pass FROM `coursework` WHERE remarks='pass' and courseID='" . $decryption1 . "' and coID='" . $cid . "')a
join
(SELECT count(*)fail FROM `coursework` WHERE remarks='fail' and courseID='" . $decryption1 . "' and coID='" . $cid . "') b";
