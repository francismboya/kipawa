...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primaryside sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="stddashboard.php">
            ...
            <!-- Tables Buttons -->
            <li class="nav-item">
                <a class="nav-link" href="stdcourse.php">
                    <i class="fas fa-fw fa-user"></i>
                    <span>COURSE</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="stdcyear.php">
                    <i class="fas fa-fw fa-user"></i>
                    <span>COURSEWORK</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="stdryear.php">
